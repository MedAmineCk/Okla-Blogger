...
<body>
    <header style="grid-area: header;">
        ...
        <h1>صفحة إنشاء وصفة جديدة</h1>
        <button>حفظ في الأرشيف</button>
    </header>
    <section class="main-container" style="grid-area: section;">
        ...
        <section class="description">
            ...
            <div class="input-container wide">
                <textarea id="description" maxlength="100" placeholder="أكتبي هنا وصفا مبصطا للوصفة"></textarea>
            </div>
        </section>
            ...
            <div class="steps steps-container">
                <div class="item">
                    ...
                    <div class="input-container"><input type="text"
                            placeholder="أكتبي هنا مراحل إعداد الوصفة، مرحلة تلوة الاخرى">
                    </div>
                    <div class="icon" onclick="$(this).parent().remove();"><span class="material-icons">delete</span>
                    </div>
                </div>
    ...
    <aside style="grid-area: aside;">
        <section class="media">
            ...
            <div class="media-source">
                ...
                <div class="preview drop-area file_drag_area">
                    <div class="icon">
                        <span class="material-icons">
                            wallpaper
                        </span>
    ...
    <div class="final" style="grid-area: final;">
        <button class="submit ripple" id="post">أنشريها</button>
        <button class="cancel ripple">إلغاء</button>
    </div>
